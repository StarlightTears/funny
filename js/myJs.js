const textConfig = {
  ...
  text3: "Tối mai nếu rảnh thì đi chơi với a nha :v, muốn muốn+ thích ôm cuddle iem. See you soon :))",
  text4:
  ...
  text8: "Gửi thử di <3",
  text9: "=)) Khum có gì đâu. Ấn gửi luôn đi",
  text10: "Thế là nhận lời rồi nhé",
  text11: "Tối nay a qua chơi :DDDDDDDDDDDDD",
    ...
    Swal.fire({
      ...
      if (result.value) {
        Swal.fire({
          ...
          onClose: () => {
            window.location =
              "https://starlighttears33.myshopify.com";
          },
        });
      }
    });
